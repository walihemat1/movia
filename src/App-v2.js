      ...
      async function getMovieDetails() {
        try {
          ...
          const res = await fetch(
            `http://www.omdbapi.com/?apikey=77d7b228&i=${selectedId}`,
        ...
        <div className="details">
          ...
          <section>
            <div className="rating">
              {movie.imdbID === alreadyWatchedMovie?.imdbID ? (
                <p>
                  You rated the movie with⭐{alreadyWatchedMovie?.userRating}
                </p>
              ) : (
                <>
                  <StartRating
      ...
      <Main>
        <Box>
          ...
          {!isLoading && !error && (
            <MovieList
              movies={movies}
              onHandleSelected={handleSelectedId}
